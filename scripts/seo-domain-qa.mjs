...
console.log(`SEO domain QA PASS: ${htmlFiles.length} HTML pages checked; ${locs.length} sitemap URLs; canonical host ${canonicalHost}; no obsolete github.io/pages.dev hosts.`);
