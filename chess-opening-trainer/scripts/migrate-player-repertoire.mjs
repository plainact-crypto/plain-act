...
main = main.replaceAll('Caro-Kann','C6 Player');
...
main=main.replaceAll('Each level contains 20 opponent first replies. The number is the depth of your training line.','Each depth covers the opponent’s 20 legal first replies. Go deeper on any branch as you improve.');
...
console.log('D4 Player now owns all 20 legal first replies after 1.d4; D4/C6 Player naming applied across the product.');
